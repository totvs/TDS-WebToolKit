...
export function DemoPage(): any {
    return (
        <TdsPage id="demoPage" title="TdsPage: Demo" showFooter={true}>
            <p><code>TdsPage</code> deve ser o primeiro elemento da sua customização, pois ela que conterá os  elementos que compõem a página. Essa região é rolável.</p>
            <p>Ajuste largura e margens usando CSS:</p>
            <pre>
                .tds-page {`{
    width: 85%;
    margin-left: auto;
    margin-right: auto;
            ...
            <p>Caso não queira os controles de leiaute, informe <code>layoutControl=false</code>.</p>
            <pre>
                &lt;TdsPage title="Demo: TdsForm" ... layoutControl=false<br />
                ...<br />
                &lt;/TdsPage&gt;
            </pre>
